...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    enable: true,
    src: "assets/images/wave1.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
  },
  favicon: [
...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    // {
    //   name: "GitHub",
    //   url: "https://github.com/saicaca/hhzzzk", // Internal links should not include the base path, as it is automatically added
